<?php
    ...
    class Seller_orderApp extends StoreadminbaseApp {
        ...
        function _get_orders() {
			...
			if($search_bygoods){
				$search_bygoodsql = "SELECT o.order_id from ".DB_PREFIX."order_goods as og left join ".DB_PREFIX."order as o on og.order_id = o.order_id  WHERE o.seller_id=" . $this->visitor->get('manage_store')." and og.goods_name like '%".$search_bygoods."%'";
