...
?>
                ...
                <p>
					...
					<a target="_blank" href="http://www.taobao.com/webww/ww.php?ver=3&touid=<?php echo urlencode($this->_var['store']['im_ww']); ?>&siteid=cntaobao&status=1&charset=<?php echo $this->_var['charset']; ?>"><img border="0" src="http://amos.alicdn.com/realonline.aw?v=2&uid=<?php echo urlencode($this->_var['store']['im_ww']); ?>&site=cntaobao&s=2&charset=<?php echo $this->_var['charset']; ?>" alt="Wang Wang" align="absmiddle" /></a>
                    <?php endif; ?>
